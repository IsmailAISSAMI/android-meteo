...
// Cette ligne, on a enlever puisque ce code a été copier d'un autre projet
//import com.example.meteo.R;
// nous aurons des erreurs qui vont pop-up, faut just faire ALT+ENTRER pour créer une classe R (ligne 13)
import com.example.meteo.R;

// Apres faut ajouter et donner des value pour ok et cancel, nous trouvrons les modifications en res>strings.xml
